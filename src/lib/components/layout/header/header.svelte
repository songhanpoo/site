...
>
	...
	<p class="not-sr-only mx-auto hidden font-semibold select-none lg:block">Home</p>
	<p class="not-sr-only mx-auto block font-semibold select-none lg:hidden">HieuNguyen</p>
	<Face />
</header>
